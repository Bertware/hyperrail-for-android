...
package be.hyperrail.research.viewgroup;
...
import be.hyperrail.research.irail.implementation.OccupancyHelper;
...
public class LiveboardStopLayout extends LinearLayout implements RecyclerViewItemViewGroup<Liveboard, VehicleStop> {
    ...
    protected void onFinishInflate() {
        ...
        vDestination = findViewById(be.hyperrail.research.R.id.text_destination);
        vTrainNumber = findViewById(be.hyperrail.research.R.id.text_train_number);
        vTrainType = findViewById(be.hyperrail.research.R.id.text_train_type);
        vTime = findViewById(R.id.text_time1);
        vDelay = findViewById(R.id.text_delay1);
        vDelayTime = findViewById(be.hyperrail.research.R.id.text_delay_time);
        vPlatform = findViewById(be.hyperrail.research.R.id.text_platform);
        vPlatformContainer = findViewById(be.hyperrail.research.R.id.layout_platform_container);

        vStatusContainer = findViewById(be.hyperrail.research.R.id.layout_train_status_container);
        vStatusText = findViewById(be.hyperrail.research.R.id.text_train_status);
