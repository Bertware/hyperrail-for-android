...
public class IrailApiParser {
    ...
    @NonNull
    private VehicleStop parseTrainStop(String headsign, VehicleStub train, JSONObject item, VehicleStopType type) throws JSONException, StationNotResolvedException {
