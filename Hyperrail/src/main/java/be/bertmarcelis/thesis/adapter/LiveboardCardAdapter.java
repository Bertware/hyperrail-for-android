...
import be.bertmarcelis.thesis.infiniteScrolling.InfiniteScrollingAdapter;
...
import be.bertmarcelis.thesis.viewgroup.LiveboardStopLayout;
...
public class LiveboardCardAdapter extends InfiniteScrollingAdapter<VehicleStop> {
    ...
    public RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_DATE) {
            itemView = LayoutInflater.from(parent.getContext()).inflate(be.bertmarcelis.thesis.R.layout.listview_separator_date, parent, false);
            return new DateSeparatorViewHolder(itemView);
        }

        if (style == STYLE_LIST) {
            itemView = LayoutInflater.from(parent.getContext()).inflate(be.bertmarcelis.thesis.R.layout.listview_liveboard, parent, false);
        } else {
            itemView = LayoutInflater.from(parent.getContext()).inflate(be.bertmarcelis.thesis.R.layout.cardview_liveboard, parent, false);
        }
