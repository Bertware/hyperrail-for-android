...
public class LiveboardStopLayout extends LinearLayout implements RecyclerViewItemViewGroup<Liveboard, VehicleStop> {
    ...
    protected void onFinishInflate() {
        ...
        vDestination = findViewById(be.bertmarcelis.thesis.R.id.text_destination);
        vTrainNumber = findViewById(be.bertmarcelis.thesis.R.id.text_train_number);
        vTrainType = findViewById(be.bertmarcelis.thesis.R.id.text_train_type);
        vTime = findViewById(R.id.text_time1);
        vDelay = findViewById(R.id.text_delay1);
        vDelayTime = findViewById(be.bertmarcelis.thesis.R.id.text_delay_time);
        vPlatform = findViewById(be.bertmarcelis.thesis.R.id.text_platform);
        vPlatformContainer = findViewById(be.bertmarcelis.thesis.R.id.layout_platform_container);

        vStatusContainer = findViewById(be.bertmarcelis.thesis.R.id.layout_train_status_container);
        vStatusText = findViewById(be.bertmarcelis.thesis.R.id.text_train_status);
