...
package be.bertmarcelis.thesis;
...
import be.bertmarcelis.thesis.R.color;
import be.bertmarcelis.thesis.R.drawable;
import be.bertmarcelis.thesis.R.id;
import be.bertmarcelis.thesis.R.layout;
import be.bertmarcelis.thesis.R.string;
import be.bertmarcelis.thesis.R.style;
...
import be.bertmarcelis.thesis.irail.implementation.RouteLegType;
import be.bertmarcelis.thesis.irail.implementation.Transfer;
import be.bertmarcelis.thesis.irail.implementation.TransferType;
...
import be.bertmarcelis.thesis.util.NotificationLayoutBuilder;
